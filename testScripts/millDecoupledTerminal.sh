...
arr=(mill002 mill004 mill005 mill006 mill007 mill008 mill009 mill010 mill015 mill016 mill020 mill021 mill058)
boxes=(mill020 mill021 mill058)
...
command1="java -Djava.net.preferIPv4Stack=true $profiler -jar workspace/mperf.jar -props $props1 -boxes"
command2="java -Djava.net.preferIPv4Stack=true $profiler -jar workspace/jgroups.jar -props $props2 -channel $channelName"
