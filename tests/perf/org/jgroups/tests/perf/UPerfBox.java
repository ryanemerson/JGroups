 ...
 * @author Bela Ban
 */
public class UPerfBox extends ReceiverAdapter {
    private JChannel               channel;
    private Address                local_addr;
    private RpcDispatcher          disp;
    static final String            groupname="uperfBox";
    ...
    static {
        try {
            METHODS[START]                 = UPerfBox.class.getMethod("startTest");
            METHODS[SET_OOB]               = UPerfBox.class.getMethod("setOOB", boolean.class);
            METHODS[SET_SYNC]              = UPerfBox.class.getMethod("setSync", boolean.class);
            METHODS[SET_NUM_MSGS]          = UPerfBox.class.getMethod("setNumMessages", int.class);
            METHODS[SET_NUM_THREADS]       = UPerfBox.class.getMethod("setNumThreads", int.class);
            METHODS[SET_MSG_SIZE]          = UPerfBox.class.getMethod("setMessageSize", int.class);
            METHODS[SET_ANYCAST_COUNT]     = UPerfBox.class.getMethod("setAnycastCount", int.class);
            METHODS[SET_USE_ANYCAST_ADDRS] = UPerfBox.class.getMethod("setUseAnycastAddrs", boolean.class);
            METHODS[SET_READ_PERCENTAGE]   = UPerfBox.class.getMethod("setReadPercentage", double.class);
            METHODS[GET]                   = UPerfBox.class.getMethod("get", long.class);
            METHODS[PUT]                   = UPerfBox.class.getMethod("put", long.class, byte[].class);
            METHODS[GET_CONFIG]            = UPerfBox.class.getMethod("getConfig");
